...
// "Internal and nestedFunction are both within the myFunction function scope"
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(myArr){
    let newArr = []
    myArr.forEach(a => newArr.push(`name: ${a['animal_name']}, scientific: ${a['scientific_name']}`))
    return newArr
  }
  ...
  */
  ...
  function lowerCaseNames(myArr){
    return myArr.map(a => a['animal_name'].toLowerCase())
  }
  ...
  */
  ...
  function lowPopulationAnimals(myArr){
    return myArr.filter(a => a.population < 5)
  }
...
//console.log(lowPopulationAnimals(zooAnimals))
  ...
  */
  ...
  function USApop(myArr){
    return myArr.reduce((a,b) => a + b['population'],0)
  }
...
function CuboidMaker(myObj){
  this.length= myObj.length;
  this.width= myObj.width;
